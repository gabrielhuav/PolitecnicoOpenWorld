...
- **REY Grupero is now playable** — the new raw sprite sheets were sliced into `SPRITES/NPC/ReyGrupero/` (`Idle=3`, `Walk=8`, `Run=8`, `Special=6`) and registered as `PlayerSkin.REY_GRUPERO`. He appears in the new-campaign character picker and the in-game character selector.
...
- **REY Grupero ya es jugable** — las nuevas hojas raw de sprites se recortaron en `SPRITES/NPC/ReyGrupero/` (`Idle=3`, `Walk=8`, `Run=8`, `Special=6`) y se registraron como `PlayerSkin.REY_GRUPERO`. Aparece en el selector de personaje de nueva campaña y en el selector de personaje dentro del juego.
