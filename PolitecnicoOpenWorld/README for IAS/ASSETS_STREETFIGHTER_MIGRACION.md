...
| 3 | 11 sonidos `.ogg` (`SOUNDS/`) | Golpes light/med/heavy, impactos, land y hadouken | Sonidos propios o CC0; **especiales por personaje YA 21/21** (`special_*.ogg` — doc **`SF_SPECIAL_VOICES_SFX.md`**, tools `curate_sf_special_sfx.py`). Falta reemplazar golpes/land/hadouken residual | 🟢 ESPECIALES OK; 🟡 golpes/land/hadouken residual pendiente |
