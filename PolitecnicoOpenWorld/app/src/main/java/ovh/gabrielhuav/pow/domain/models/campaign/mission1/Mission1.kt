 ...
 * e ingreso a la ESCOM (+ objetivo de interiores "busca pistas"). Objetivos y constantes
 * de la misión, agrupados en su propia carpeta `mission1/` para escalar a futuras misiones
 * (mission2/, …). El agregador público es [ovh.gabrielhuav.pow.domain.models.campaign.MissionCatalog].
 */
object Mission1 {
