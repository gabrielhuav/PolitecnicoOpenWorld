        ...
        if (count == 0) {
            val defaultList = listOf(
                CollectibleEntity(
                    ...
                    assetPath = "coleccionables/colec_1.webp"
                ),
                CollectibleEntity(
                    id = "c_2",
                    ...
                    assetPath = "coleccionables/colec_2.webp"
                ),
                CollectibleEntity(
                    id = "c_3",
                    name = "Gloriosa ESIME",
                    ...
                    assetPath = "coleccionables/colec_3.webp"
                ),
                CollectibleEntity(
                    id = "c_4",
                    name = "ETS",
                    ...
                    assetPath = "coleccionables/colec_4.webp"
                ),
                CollectibleEntity(
                    id = "c_5",
                    name = "Laptop escomia",
                    ...
                    assetPath = "coleccionables/colec_5.webp"
                ),
                CollectibleEntity(
                    id = "c_6",
