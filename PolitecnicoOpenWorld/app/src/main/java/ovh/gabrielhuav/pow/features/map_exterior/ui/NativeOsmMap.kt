...
// REFACTOR: `renderPrankedyOnMap` (render del NPC Prankedy + proyectil) se movió a
// `NativeOsmMapPrankedy.kt`, y la clase `FogOverlay` (neblina) a `NativeOsmMapFog.kt`,
// ambas `internal` en el mismo paquete `ui`. Ver 09 §0.
