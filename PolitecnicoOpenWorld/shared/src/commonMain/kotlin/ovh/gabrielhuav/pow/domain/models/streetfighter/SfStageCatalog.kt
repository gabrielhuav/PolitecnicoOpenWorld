 ...
 * - Día:            `fondo_<slug>_anim.webp`
 * - Noche:          `fondo_<slug>_noche_1_anim.webp`
 * - Noche apocalíptica: `fondo_<slug>_noche_2_anim.webp`
 *
...
object SfStageCatalog {
    ...
    data class Stage(
        ...
        fun file(lighting: Lighting): String = when (lighting) {
            ...
            Lighting.NIGHT -> dayFile.replace("_anim.webp", "_noche_1_anim.webp")
            Lighting.APOCALYPSE -> dayFile.replace("_anim.webp", "_noche_2_anim.webp")
        }
    }
    ...
    val CECYT_9 = Stage("cecyt_9", "CECyT 9", "fondo_cecyt_9_anim.webp")
    val CECYT_2 = Stage("cecyt_2", "CECyT 2", "fondo_cecyt_2_anim.webp")
    val UNAM_CU = Stage("unam_biblioteca_cu", "Ciudad Universitaria UNAM", "fondo_unam_biblioteca_cu_anim.webp")
    val FES_ACATLAN = Stage("fes_acatlan", "FES Acatlán", "fondo_fes_acatlan_anim.webp")
    val UAM_AZCAPO = Stage("uam_azcapo", "UAM Azcapotzalco", "fondo_uam_azcapo_anim.webp")
    val ISLA_MUNECAS = Stage("islamunecas", "Isla de las Muñecas", "fondo_islamunecas_anim.webp")
    val MICTLÁN = Stage("mictlan", "Mictlán", "fondo_mictlan_anim.webp")
    val AGAVE = Stage("campos_agave_jalisco", "Campos de Agave Jalisco", "fondo_campos_agave_jalisco_anim.webp")
    val FAC_MED = Stage("facultad_medicina", "Facultad de Medicina", "fondo_facultad_medicina_anim.webp")
    val FES_ARAGON = Stage("fes_aragon", "FES Aragón", "fondo_fes_aragon_anim.webp")
    ...
    /** Migra nombres guardados por versiones anteriores al atlas WebP equivalente. */
    fun normalizeFile(file: String): String =
        if (file.endsWith("_anim.png")) file.removeSuffix(".png") + ".webp" else file

    /**
     * Resuelve a qué [Stage] pertenece un archivo (`…_anim.webp` / `…_noche_1_anim.webp` / …).
